...
Label(frame2, text = '', font='arial 12 bold').pack(side=LEFT) 
address = Text(frame2,width=3,height=1) 
address.pack() 

Button(root,text="Add",font="arial 12 bold",command=add).place(x= 950, y=70) 
...
Button(root,text="Reset",font="arial 12 bold",command=reset).place(x= 1000, y=70) 
